...
from resources import ConsentResource, StudyResource, SurveyResource, CompleteResource,RecordResource, TutorialResource, TutorialResource2
...
@click.option("--db", required=True, type=click.Path(exists=False), help="Path to the SQLite database file.")
